...
function PromptsPanel({ category, showBatch, selectedModels = [] }) {
  ...
  const apiBase = `/api/prompts`;
  const listUrl = `${apiBase}?category=${category}`;
  ...
  async function handleSave(form) {
    ...
    try {
      ...
      const url = isEdit ? `${apiBase}/${editing.id}` : apiBase;
      ...
      {loading ? (
        ...
        >
          <Typography level="body-md" textColor="neutral.500">
            No prompts yet. Click <strong>Add Prompt</strong> to create your
            first one.
          </Typography>
        </Sheet>
      ) : (
        <Sheet
          variant="outlined"
          sx={{ borderRadius: "md", overflow: "auto", mb: 2 }}
        >
          <Table
            hoverRow
            stickyHeader
          ...
          >
            <thead>
              <tr>
                ...
                <th style={{ width: showBatch ? 160 : 120 }}>Actions</th>
              </tr>
            </thead>
            <tbody>
              {prompts.map((p) => (
  ...
  return (
    <Box sx={{ flex: 1, overflow: "auto", p: 3 }}>
      ...
      <Tabs defaultValue="personal">
        <TabList>
          <Tab value="personal">My Prompts</Tab>
          <Tab value="market">Market</Tab>
        </TabList>

        <TabPanel value="personal" sx={{ px: 0, pt: 3 }}>
          <PromptsPanel
            category="personal"
            showBatch
            selectedModels={selectedModels}
        ...
        <TabPanel value="market" sx={{ px: 0, pt: 3 }}>
          <PromptsPanel category="market" showBatch={false} />
        </TabPanel>
      </Tabs>
    </Box>
  );
